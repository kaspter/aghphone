...
**
** Created: Mon Jun 30 02:46:46 2008
...
static const char qt_meta_stringdata_AghPhoneDialog[] = {
    "AghPhoneDialog\0\0callSlave()\0"
};

const QMetaObject AghPhoneDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AghPhoneDialog,
...
void *AghPhoneDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::AghPhoneUI"))
	return static_cast< Ui::AghPhoneUI*>(const_cast< AghPhoneDialog*>(this));
